            ...
            {isAuthenticated ? (
              ...
              <div className="d-flex gap-2">
                ...
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                  <Link to="/signup" className="btn btn-stash-primary text-nowrap">
                    Sign Up 🚀
                  </Link>
                </motion.div>
              </div>
        ...
        <div className="container py-4">
          <div className="row align-items-center g-5">
            <motion.div 
              ...
              animate="visible"
            >
              <motion.span variants={itemVariants} className="badge bg-purple-subtle px-3 py-2 rounded-pill fw-bold mb-3 d-inline-block">
                🇮🇳 #1 Savings & Goal Tracker App for Gen Z & Teens
              </motion.span>
              
              <motion.h1 variants={itemVariants} className="brand-font display-4 fw-extrabold text-dark mb-3" style={{ lineHeight: '1.2' }}>
              ...
              <motion.p variants={itemVariants} className="lead text-secondary mb-4 fs-5">
              ...
              <motion.div variants={itemVariants} className="d-flex flex-wrap gap-3 mb-4">
                <motion.div whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.96 }}>
                  <Link to="/onboarding" className="btn btn-stash-primary btn-lg px-4 py-3 shadow w-100">
                ...
                <motion.button 
                  ...
                  whileTap={{ scale: 0.96 }}
                  className="btn btn-stash-secondary btn-lg px-4 py-3" 
              ...
              {/* Trust Badges */}
              <motion.div variants={itemVariants} className="d-flex align-items-center gap-4 pt-2 border-top">
                <div>
            ...
            {/* Interactive Showcase Graphic with Floating Animations */}
            <div className="col-12 col-lg-6 text-center">
              <motion.div
                ...
                whileHover={{ y: -6 }}
                className="stash-card p-4 p-md-5 mx-auto shadow-lg position-relative glow-ring-purple" 
        ...
        <div className="container py-4">
          ...
          >
            <div className="col-12 col-md-4">
              <motion.div variants={itemVariants} whileHover={{ y: -6 }} className="stash-card p-4 h-100">
      ...
      <section className="py-5 bg-body">
        <div className="container py-3">
          <motion.div 
            ...
            className="gradient-callout-card p-4 p-md-5 d-flex flex-wrap align-items-center justify-content-between gap-4"
          >
            ...
            <motion.button 
              ...
              whileTap={{ scale: 0.94 }}
              className="btn btn-light btn-lg rounded-pill fw-bold text-purple px-4 py-3" 
              onClick={toggleTheme}
            >
